...
function Navbar({showCountdown, isPracticing}) {
    ...
    return (
        <div className={styles.navbar}>
            <Link to={`/`}> <img src="/logo_transparent.svg" alt="Perfect Pitch Puzzle logo" className={styles.logo} /></Link>
